...
namespace SWBC
{
	...
	class PointTurnController : public controller_interface::MultiInterfaceController<
	...
	const std::string PointTurnController::DEF_ROBOT_DESC_NAME = "robot_description";
	const std::string PointTurnController::DEF_BASE_LINK = "base_link";
	const double PointTurnController::DEF_CMD_VEL_TIMEOUT = 0.5;

	const double PointTurnController::DEF_LIN_SPEED_LIMIT = 1;
	const double PointTurnController::DEF_LIN_ACCEL_LIMIT = 1;
	const double PointTurnController::DEF_LIN_DECEL_LIMIT = -1;

	const double PointTurnController::DEF_YAW_SPEED_LIMIT = 1;
	const double PointTurnController::DEF_YAW_ACCEL_LIMIT = 1;
	const double PointTurnController::DEF_YAW_DECEL_LIMIT = -1;

	const double PointTurnController::DEF_FULL_AXLE_SPEED_ANG = 0.7854;
	const double PointTurnController::DEF_ZERO_AXLE_SPEED_ANG = 1.5708;

	const double PointTurnController::DEF_WHEEL_DIA_SCALE = 1;

	const double PointTurnController::DEF_ODOM_PUB_FREQ = 30;
	const bool PointTurnController::DEF_PUB_ODOM_TO_BASE = true;
	const std::string PointTurnController::DEF_ODOM_FRAME = "odom";
	const std::string PointTurnController::DEF_BASE_FRAME = "base_link";
	const double PointTurnController::DEF_INIT_X = 0;
	const double PointTurnController::DEF_INIT_Y = 0;
	const double PointTurnController::DEF_INIT_YAW = 0;
	const double PointTurnController::DEF_SD = 0;

	// X direction
	const Eigen::Vector2d PointTurnController::X_DIR = Eigen::Vector2d::UnitX();
}
